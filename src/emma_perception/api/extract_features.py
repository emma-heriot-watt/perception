...
def get_batch_features(
    ...
    with tracer.start_as_current_span("Run model inference"):
        with torch.no_grad():
    ...
    with tracer.start_as_current_span("Parse model output"):
...
def extract_features_for_batch(
    ...
    with tracer.start_as_current_span("Extract for all batches"):
        for batch in loader:
